...
class EmbeddingsManager:
    ...
    def create_embeddings(self, pdf_path: str):
        ...
        # Create and store embeddings in Qdrant with vectors
        try:
            # Create Qdrant client
            client = QdrantClient(path=self.qdrant_path)
            
            # Delete old collection and recreate fresh — ensures only current doc is indexed
            try:
            ...
            # Add documents with vectors manually
